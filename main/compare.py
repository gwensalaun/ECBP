...
if __name__ == '__main__':
    ...
    if (len(sys.argv)<5):
        ...
        print("Expected syntax: python3 compare.py ex1.bpmn ex2.bpmn box|full branching|safety|trace|weaktrace")
        ...
        ident2=tmp[0]
        # print("load: " + '../comparison/bpmn-comp.maude')
        maude.load('../comparison/bpmn-comp.maude')
        maude.load(ident1+'.maude')
        maude.load(ident2+'.maude')
        # print("load: " + 'omod EX1 is inc BPMN-COMPARISON . inc '+ident1+' . inc '+ident2+' . endom')
        ...
        if (option=="full"):
            ...
            # print("erew " + 'writeAutFile('+ident1+',"'+ident1+'")')
            tf1 = run.parseTerm('writeAutFile('+ident1+',"'+ident1+'")')
            tf1.erewrite()
            # print("erew " + 'writeAutFile('+ident2+',"'+ident2+'")')
            tf2 = run.parseTerm('writeAutFile('+ident2+',"'+ident2+'")')
            tf2.erewrite()
            # print('bcg_io '+ident1+'.aut .bcg')
            call('bcg_io '+ident1+'.aut .bcg', shell=True)
            # call('bcg_labels -hide file.hid '+ident1+'.bcg', shell=True)
            # print('bcg_io '+ident2+'.aut .bcg')
            call('bcg_io '+ident2+'.aut .bcg', shell=True)
            # call('bcg_labels -hide file.hid '+ident2+'.bcg', shell=True)
            # print('bcg_open '+ident1+'.bcg bisimulator -'+equiv+' '+ident2+'.bcg')
            res=call('bcg_open '+ident1+'.bcg bisimulator -'+equiv+' '+ident2+'.bcg', shell=True)
            # clean()
        else:
            # COMPARISON USING BOXES
            print("EFFICIENT COMPARISON USING BOXES: ")
            # print("erew " + 'compare('+ident1+','+ident2+', "'+ident1+"-"+ident2+'", true)')
            ...
            if t.equal(s):
                ...
                if (int(res)>2):
                    ...
                    for i in range(nbcouples):
                        ...
                        # call('bcg_labels -hide file.hid output_'+ident1+"-"+ident2+'_'+str(i)+'_0.bcg', shell=True)
                        call('bcg_io output_'+ident1+"-"+ident2+'_'+str(i)+'_1.aut .bcg', shell=True)
                        # call('bcg_labels -hide file.hid output_'+ident1+"-"+ident2+'_'+str(i)+'_1.bcg', shell=True)
                        res=call('bcg_open output_'+ident1+"-"+ident2+'_'+str(i)+'_0.bcg bisimulator -'+equiv+' output_'+ident1+"-"+ident2+'_'+str(i)+'_1.bcg', shell=True)

                else:
                    # print("DEBUT CONVERT1")
                    # print('call: '+'bcg_io output_'+ident1+"-"+ident2+'_0_0.aut .bcg')
                    call('bcg_io output_'+ident1+"-"+ident2+'_0_0.aut .bcg', shell=True)
                    # call('time bcg_labels -hide file.hid  output_'+ident1+"-"+ident2+'_0_0.bcg', shell=True)
                    #print("DEBUT CONVERT2")
                    # print('call: '+'bcg_io output_'+ident1+"-"+ident2+'_0_1.aut .bcg')
                    call('bcg_io output_'+ident1+"-"+ident2+'_0_1.aut .bcg', shell=True)
                    # call('time bcg_labels -hide file.hid  output_'+ident1+"-"+ident2+'_0_1.bcg', shell=True)
                    #print("DEBUT COMP")
                    # print('call: '+'bcg_open output_'+ident1+"-"+ident2+'_0_0.bcg bisimulator -'+equiv+' output_'+ident1+"-"+ident2+'_0_1.bcg')
                    res=call('bcg_open output_'+ident1+"-"+ident2+'_0_0.bcg bisimulator -'+equiv+' output_'+ident1+"-"+ident2+'_0_1.bcg', shell=True)
